                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="flex items-center gap-5">
                                                <div>
                                                    ...
                                                    <input type="date" className="focus:outline-none border p-1" defaultValue={item.hasOwnProperty("start_date") ? item.start_date :null} onChange={(e) => handlerChange(e.target.value, "start_date")} />
                                                </div>
                                                <div>
                                                    <h1 className="text-zinc-500 dark:text-zinc-300 text-xs">Due Date</h1>
                                                    <input type="date" defaultValue={item.hasOwnProperty("start_date") ? item.start_date :null} className="focus:outline-none border p-1" onChange={(e) => handlerChange(e.target.value, "due_task")}/>
                                                </div>
                                            </div>
                                        </div>
