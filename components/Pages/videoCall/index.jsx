...
export default function VideoCall(props) {
    ...
    useEffect(async () => {
        ...
        const resUser = await AuthRepository.getStatus({ param: "user", "xa": getXA })
        setDataUser(resUser)
        console.log("res user brooo")
        console.log(resUser)

        // untuk data meet
        setDataMeet({
            "title": "meetbersama",
            "use_password": 0,  // 0 no password, 1 use password
            "password": "admin123"
        })
        setAudioOnly(false)
                        ...
                        <div className="sm:flex sm:items-center sm:justify-between">
                            <div>
                                <div className="flex items-center gap-x-3">
                                    <h2 className="text-lg font-medium text-gray-800 dark:text-white">Video Call History</h2>

                                    <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">240 history</span>
                                </div>
                            ...
                            <div className="flex items-center mt-4 gap-x-3">
                                ...
                                <button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600" onClick={() => handleOpenMeet("aaa")} >
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                        <div className="inline px-3 py-1 text-sm font-normal text-red-500 bg-red-100 rounded-full dark:text-gray-400 gap-x-2 dark:bg-gray-800">
                                                            Canceled
                                                        </div>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
