        ...
        <div className="sm:flex sm:items-center sm:justify-between mb-2">
            <div>
                <div className="flex items-center gap-x-3">
                    <h2 className="text-lg font-medium text-zinc-800 dark:text-white">Goals And Progress</h2>
                    ...
                    <div className="overflow-y-hidden border border-zinc-200 dark:border-zinc-700 md:rounded-lg">
                        <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                            <thead className="bg-zinc-50 dark:bg-zinc-800">
                                <tr>
                                    <th></th>
                                    <th className="group w-5 relative font-bold p-3 text-sm border-r text-left rtl:text-right text-zinc-500 dark:text-zinc-400">No</th>
                                    {
