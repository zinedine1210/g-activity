...
export default function MenuBoard(props) {
    ...
    console.log("profileData menu board", profileData)
            ...
            <nav className="w-full mt-5">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {
                            (profileData['_bitws']['edit'] & profileData['_feature']['ga_task']) ? <button disabled={dataBoard ? false : true} onClick={() => handlerSave()} className="disabled:bg-zinc-500 hover:bg-blue-400 transition-all bg-primary rounded-md text-white px-3 py-2 font-semibold text-sm flex items-center gap-2">
                                {lang("save")}
                                <FaSave />
                            </button> : null
                        }
