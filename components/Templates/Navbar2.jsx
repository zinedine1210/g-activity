...
export default function Navbar2(props) {
  ...
  return (
    <section id="header" className={`bg-white xl:backdrop-blur-md z-40 transition-transform sticky top-0 left-0 border-t border-b border-t-transparent border-zinc-500/20 w-full ease-in-out duration-500 `}>
      <div className="my-4 px-3 md:px-5">

        {/* Desktop */}
        <div className="hidden md:flex items-center gap-8">
          <button onClick={() => handleDrawer()} className={`text-blue-500 hover:text-blue-300 duration-300 ease-in-out`}><svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7"></path></svg></button>
