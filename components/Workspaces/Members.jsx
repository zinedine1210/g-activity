                    ...
                    if(item.status == -1)
                        return (
                            <li key={key} className="w-full flex items-center justify-between gap-2 py-3 relative border-b">
                                <div className="flex items-center gap-2">
                                    <span className="w-12 h-12 bg-black rounded-full flex items-center text-white font-bold justify-center uppercase">{item.email.charAt(0)}</span>
                                    <div>
                                        <h1 className="font-semibold text-sm">{item.email}</h1>
                                        <p className="text-zinc-600 dark:text-zinc-300 font-semibold text-sm">User</p>
                                    </div>
                                </div>
                                <h1 className="text-zinc-600 dark:text-zinc-300">Pending</h1>
                                <div>
