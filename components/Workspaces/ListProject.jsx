        ...
        <div className="py-10">
            ...
            <div className="flex items-center justify-between gap-5 mb-5 bg-blue-100 dark:bg-blue-500 px-5 rounded-xl">
                <div className="flex items-center gap-2">
                    {
                        owner && <button onClick={() => handleTab("myProject")} className={`${active == "myProject" ? "border-b-2 border-primary dark:border-white" : ""} hover:bg-blue-200 dark:hover:bg-blue-600 duration-300 transition-colors py-4 px-3 text-sm md:text-base`}>
                            Your Project
                        </button>
                    }
