    ...
    const menuItems = [
        {
            ...
            badge: "3",
            className: "bg-gray-500 bg-opacity-30 text-blue-600"
        },
        {
            title: "Starred",
            icon: (
            ...
            className: "hover:bg-gray-500 hover:bg-opacity-10 hover:text-blue-600 text-gray-700"
        },
        {
            title: "Snoozed",
            icon: (
            ...
            <div className="px-2 pt-4 pb-8 border-r border-gray-300 h-screen">
                <ul className="space-y-2">
                    {menuItems.map((item, index) => (
                        <li key={index}>
                            <a
                                className={`${item.className} flex items-center justify-between py-1.5 px-4 rounded cursor-pointer`}
                                onClick={item.action}
                            >
