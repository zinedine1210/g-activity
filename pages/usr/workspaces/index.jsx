        ...
        <section className="min-h-screen contain px-2 md:px-20 pt-32">
            ...
            <div className="flex items-center justify-between gap-5 mt-5 bg-blue-100 dark:bg-blue-500 px-5 rounded-xl">
                <div className="flex items-center gap-2">
                    <button onClick={() => handleTab("myWork")} className={`${active == "myWork" ? "border-b-2 border-primary dark:border-white":""} hover:bg-blue-200 dark:hover:bg-blue-600 duration-300 transition-colors py-4 px-3 text-sm md:text-base`}>
                        Your Work
                    </button>
