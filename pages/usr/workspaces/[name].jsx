          ...
          dataWorkspace ? (
            <>
              <div className="flex items-center gap-2 mt-5 w-full overflow-x-auto">
                ...
                {
                  // check permission delete workspace
                  workspaceOwner && (profileData['_bitws']['delete'] & profileData['_feature']['workspace']) ? (
                    <>
              ...
              {
                active == 2 ?
                  <General setActive={() => context.setDataDocumentation(context.dataDocumentation)} data={dataWorkspace} profileData={profileData} />
                  : ""
              }
              {
                active == 4 ?
