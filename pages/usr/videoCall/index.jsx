        ...
        <section className="min-h-screen contain px-2 md:px-20 pt-32">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati, eligendi.</p>
                </div>
